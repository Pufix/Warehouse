<html>
	...
	<body style="padding: 0px;">
        ...
        <table width=100% class="tabelprodred" style="zoom: 1.75; -moz-transform: scale(1.75); -moz-transform-origin: 0 0;" cellspacing=0>
            ...
            $sql =
                "SELECT comenzitrimise.idprod AS ID_Produs , comenzitrimise.cantitate AS Cantitate , comenzitrimise.magazin AS Destinatar FROM `comenzitrimise` ORDER BY `comenzitrimise`.`id` DESC";
